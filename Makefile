...
deploy: kustomize
	...
	$(KUSTOMIZE) build --load_restrictor LoadRestrictionsNone config/${OVERLAY} | kubectl apply -f -

# Undeploy controller in the configured Kubernetes cluster in ~/.kube/config
undeploy: kustomize
	$(KUSTOMIZE) build --load_restrictor LoadRestrictionsNone config/${OVERLAY} | kubectl delete -f -
